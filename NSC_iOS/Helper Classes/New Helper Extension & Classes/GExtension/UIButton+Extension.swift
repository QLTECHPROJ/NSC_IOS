...
//            self.setTitle(titleValue.localized, for: UIControl.State.normal)
    ...
    func applystyle(isAdjustToFont : Bool = false ,isApsectRadio : Bool = true,cornerRadius : CGFloat = 0,fontname : CustomFont,fontsize : CGFloat = kMediumFontSize,bgcolor : UIColor = .clear,titleText : String? = nil,titleColor : UIColor = .colorAppTextBlack,shadowColor: UIColor = .clear,opacity : Float = 0.0,shadowOffset : CGSize = CGSize(width: 0, height: 0),shdowRadius : CGFloat = 0.0, borderColor : UIColor = .clear, borderWidth : CGFloat = 0.0){
    ...
    func setContentEdges(contentEngesLeft : CGFloat = 0, contentEngesRight : CGFloat = 0,contentEngesTop : CGFloat = 0, contentEngesBottom : CGFloat = 0, titleEngesLeft : CGFloat = 0, ImageEngesLeft : CGFloat = 0,titleEngesRight : CGFloat = 0, ImageEngesRight : CGFloat = 0){
//        if GFunctions.shared.checkDeviceiPhone(){
            ...
            self.titleEdgeInsets.right = titleEngesRight
            
            self.imageEdgeInsets.left = ImageEngesLeft
            self.imageEdgeInsets.right = ImageEngesRight
...
//
//            self.titleEdgeInsets.right = titleEngesRight * 2.0
//
//            self.imageEdgeInsets.left = ImageEngesLeft * 2.0
//
//            self.imageEdgeInsets.right = ImageEngesRight * 2.0
//        }
    }
}
