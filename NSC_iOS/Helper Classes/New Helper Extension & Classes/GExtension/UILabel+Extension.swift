...
//                self.text = textValue.localized
    ...
    func applyLabelStyle(isAdjustFontWidth : Bool = false,isApsectRadio : Bool = true, text : String = "",fontSize : CGFloat = kMediumFontSize,fontName : CustomFont,textColor : UIColor = UIColor.colorAppTextBlack,backGroundColor : UIColor = .clear){
