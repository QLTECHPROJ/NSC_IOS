...
extension UITextField {
    ...
    func applyStyleTextField(isAspectRatio : Bool = true,leftImage : UIImage? = nil,leftImageContentMode : UIView.ContentMode = .center,rightImage : UIImage? = nil, rightImageContentMode : UIView.ContentMode = .center, x : Int? = 0, y : Int? = 0, w : Int? = 0, h : Int? = 0,placeholder : String? = nil,placeHolderColor : UIColor = .colorAppTxtFieldGray,textColor : UIColor = .colorAppTextBlack,fontsize : CGFloat,fontname : CustomFont,mode : UITextField.ViewMode? = .always){
